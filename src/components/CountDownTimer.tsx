...
export default function CountdownTimer({
  ...
  return (
    <div className="container gap-3 py-5 pr-7 rounded-3xl md:-mt-24 md:relative md:z-10 md:bg-white/70 md:backdrop-blur-ьв md:shadow-[0_-20px_40px_20px_rgba(255,255,255,1)]">
